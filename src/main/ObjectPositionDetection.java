...
public class ObjectPositionDetection {
	static int hueLowerR = 160;
	static int hueUpperR = 180;

	public static void main(String[] args) {
		IplImage orgImg = cvLoadImage("threshold.jpg");
		//IplImage thresholdImage = hsvThreshold(orgImg);
		//cvSaveImage("hsvthreshold.jpg", thresholdImage);
		Dimension position = getCoordinates(orgImg);
		System.out.println("Dimension of original Image : " + orgImg.width() + " , " + orgImg.height());
